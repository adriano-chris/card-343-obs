...
CREATE OR REPLACE PACKAGE BODY CHRISERP.chrpp_mf007_pkg IS
        ...
        Begin
           Select Max(a.Cd_Centro_Custo)
            ...
            Where a.Sq_Maquina  = b.Sq_Maquina
              And b.Cd_Maquina  = V_Cod_Maquina
   ...
   Begin
       ...
       Open P_Cursor For
         Select Maquina, a.Centro_Trabalho, To_Char(Contador) Contador,
                Codigo_Defeito, b.Descricao, Qtde, Observacao, a.sq_lote, c.Cd_Fam Nr_Rastrea
           From Ztpp_Apt_Desvio a,
                Ztpp_Desvio b,
                Pd_Lote_Rastrea c
