...
BEGIN
    ...
    chrpp_mf007_pkg.Lista_Tecnica_Comp_Filho(  P_Nr_Ordem    => '1851486' -- 1851486
                                             , P_Mandt       => '400'
                                             , P_Cursor      => v_cursor
...
BEGIN
     ---------------------------------
     -- VISÃO ANALÍTICA DO APONTAMNTO:
     ---------------------------------
     chrpp_mf007_pkg.Lista_Apontamento(  P_Nr_Ordem              => '1880380'
                                       , P_Idex_Comp             => 1
                                       , P_Cursor                => P_Cursor
...
Select * from Ztpp_Apt_Desvio Where 0=0 AND ORDEM_PRODUCAO = '000001851486' AND Sq_Lote = '219348' Order By Contador, Index_Comp; 
